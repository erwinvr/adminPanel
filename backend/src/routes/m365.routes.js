...
import { saveSettingsSchema, listUsersQuerySchema } from '../validators/m365.validator.js';
...
router.get('/users/summary', requirePermission(PERMISSIONS.M365_VIEW), asyncHandler(m365Controller.getUsersSummary));

router.get(
  '/users',
  requirePermission(PERMISSIONS.M365_VIEW),
  validateQuery(listUsersQuerySchema),
  asyncHandler(m365Controller.listUsers)
);
