...
import { ADAdministratorsPage } from './pages/ADAdministratorsPage.jsx';
...
export function App() {
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path="/ad/administrators"
        element={
          <ProtectedRoute permission={PERMISSIONS.AD_VIEW}>
            <ADAdministratorsPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/ad/operations"
        element={
          <ProtectedRoute permission={PERMISSIONS.AD_OPERATIONS_VIEW}>
            <ADOperationsPage />
          </ProtectedRoute>
        }
      />
